...
func (ac AuthController) Login(c *gin.Context) {
	...
	if user.Password == encryptedPassword {
		...
		loginResult.User = user.ToResponse(ac.env)
...
func (ac AuthController) AccessTokenVerify(c *gin.Context) {
	...
	valid, _, err := authServices.DecodeToken(accessToken, accessSecret)
	if err != nil {
...
func (ac AuthController) RenewToken(c *gin.Context) {
	...
	valid, atClaims, err := authServices.DecodeToken(refreshToken, refreshSecret)
	if err != nil {
